...
::: tip BUILD CONSISTENCY
KernelSU's kernel, `ksud`, and Manager communicate through a shared UAPI. If you change UAPI headers, app profile structures, ioctl numbers, or feature IDs in a custom build, rebuild the matching userspace and Manager components from the same source tree.
:::
