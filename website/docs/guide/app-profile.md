...
App Profile data is shared across the kernel, `ksud`, and the Manager through the KernelSU UAPI. When upgrading KernelSU, update these components together and avoid mixing builds that use different App Profile or UAPI versions.
