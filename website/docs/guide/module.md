...
For upgrades, this means module authors should not assume that mounting is always available. A module that needs `/system` overlays should document its metamodule requirement, while script-only modules should continue to work without one.
