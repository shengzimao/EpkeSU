...
private fun defaultSegmentedColors(): ListItemColors = ListItemDefaults.segmentedColors().copy(
    containerColor = if (isLiquidGlassTheme()) colorScheme.surfaceColorAtElevation(1.dp).copy(alpha = 0.56f) else colorScheme.surfaceColorAtElevation(1.dp),
    disabledContainerColor = if (isLiquidGlassTheme()) colorScheme.surfaceColorAtElevation(1.dp).copy(alpha = 0.40f) else colorScheme.surfaceColorAtElevation(1.dp),
